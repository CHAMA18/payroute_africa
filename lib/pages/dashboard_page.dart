...
_buildHeader(textPrimary, textSecondary, operationalCount, degradedCount, downCount, isDark, border, isCompact),
...
Widget _buildHeader(Color textPrimary, Color textSecondary, int operationalCount, int degradedCount, int downCount, bool isDark, Color border, bool isCompact) {
final titleRow = Row(
mainAxisSize: MainAxisSize.min,
children: [
...
if (degradedCount > 0) _StatusPill(count: degradedCount, label: 'Degraded', color: const Color(0xFFF59E0B), isDark: isDark),
if (downCount > 0) _StatusPill(count: downCount, label: 'Down', color: const Color(0xFFEF4444), isDark: isDark),
viewStatusBtn,
],
),
],
...
const SizedBox(height: 12),
Text(widget.label, style: GoogleFonts.inter(color: textSecondary, fontSize: 12, fontWeight: FontWeight.w500), overflow: TextOverflow.ellipsis),
const SizedBox(height: 4),
FittedBox(
  fit: BoxFit.scaleDown,
  alignment: Alignment.centerLeft,
  child: Text(widget.value, style: GoogleFonts.inter(color: textPrimary, fontSize: 20, fontWeight: FontWeight.w800)),
),
],
),
),
...
const SizedBox(width: 8),
Expanded(child: Text('Latency Comparison', style: GoogleFonts.inter(color: textPrimary, fontSize: 15, fontWeight: FontWeight.w700), overflow: TextOverflow.ellipsis)),
const SizedBox(width: 8),
Container(
padding: const EdgeInsets.symmetric(horizontal: 10, vertical: 5),
decoration: BoxDecoration(
...
const SizedBox(width: 8),
Expanded(child: Text('Uptime Rankings', style: GoogleFonts.inter(color: textPrimary, fontSize: 15, fontWeight: FontWeight.w700), overflow: TextOverflow.ellipsis)),
],
),
const SizedBox(height: 16),
...
const SizedBox(width: 8),
Expanded(child: Text('Recent Events', style: GoogleFonts.inter(color: textPrimary, fontSize: 15, fontWeight: FontWeight.w700), overflow: TextOverflow.ellipsis)),
const SizedBox(width: 8),
Container(
padding: const EdgeInsets.symmetric(horizontal: 10, vertical: 5),
decoration: BoxDecoration(
...
child: Text(railName, style: GoogleFonts.inter(color: textSecondary, fontSize: 10, fontWeight: FontWeight.w600), overflow: TextOverflow.ellipsis),
),
),
),
const SizedBox(width: 8),
