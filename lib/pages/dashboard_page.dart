...
class _DashboardPageState extends State<DashboardPage> {
              ...
              AnimatedSize(
                ...
                child:
                    showAside
                        ? SizedBox(
                          width: 360,
                          child: _AsidePanel(brightness: b),
                        )
  ...
  Future<void> _showQuickActionsModal(
    ...
    await showGeneralDialog<void>(
      ...
      barrierColor: Colors.black.withValues(
        alpha: brightness == Brightness.dark ? 0.6 : 0.32,
      ),
      transitionDuration: const Duration(milliseconds: 260),
      pageBuilder: (context, animation, secondaryAnimation) {
        return _QuickActionsModal(brightness: brightness);
      },
                ...
                Positioned(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      gradient: RadialGradient(
                        colors: [
                          PayRouteColors.electricGlow.withValues(
      ...
      builder: (context, constraints) {
        ...
        final titleBlock = Column(
          ...
          children: [
            ...
            Text(
              'Real-time financial routing status',
        ...
        return Container(
          ...
          child: Row(
            children: [
              ...
              if (!isTight) ...[searchPill, const SizedBox(width: 16)],
...
class _QuickActionsHeaderButton extends StatelessWidget {
  ...
  const _QuickActionsHeaderButton({
    required this.brightness,
    ...
    return Semantics(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(
            color: isOpen ? activeColor.withValues(alpha: 0.24) : border,
          ),
        ),
        child: Material(
  ...
  Widget build(BuildContext context) {
    ...
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        final topUpButton = _TopUpButton(
          brightness: brightness,
          isCompact: isCompact,
        );
        ...
        return Container(
          decoration: BoxDecoration(
            color: surface.withValues(
              alpha: brightness == Brightness.dark ? 0.72 : 0.95,
            ),
            borderRadius: BorderRadius.circular(24),
            border: Border.all(color: border),
            boxShadow: [
                            ...
                            decoration: BoxDecoration(
                              ...
                              gradient: LinearGradient(
                                ...
                                colors: [
                                  ...
                                  PayRouteColors.dashboardPrimary.withValues(
                                    alpha: 0.7,
                                  ),
                                ],
                              ),
...
class _LiveHealthSectionState extends State<_LiveHealthSection>
    with SingleTickerProviderStateMixin {
  ...
  final List<PaymentRailData> _rails = [
    ...
    PaymentRailData(
      ...
      recentEvents: [
        RailEvent(
          ...
          message: 'Elevated latency in APAC region',
    ...
    PaymentRailData(
      ...
      recentEvents: [
        RailEvent(
          type: EventType.success,
          message: 'Peak capacity handled successfully',
    ...
    PaymentRailData(
      ...
      recentEvents: [
        RailEvent(
          type: EventType.success,
          message: 'Record throughput achieved',
    ...
    PaymentRailData(
      ...
      recentEvents: [
        RailEvent(
          type: EventType.success,
          message: 'Authorization rate at 99.2%',
  ...
  Widget build(BuildContext context) {
    ...
    final operationalCount =
        _rails.where((r) => r.status == RailStatus.operational).length;
    final degradedCount =
        _rails.where((r) => r.status == RailStatus.degraded).length;
  ...
  Widget _buildHeader(
    ...
    final viewStatusBtn = MouseRegion(
...
class _SystemOverviewCards extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final avgLatency =
        rails.map((r) => r.latency).reduce((a, b) => a + b) ~/ rails.length;
    final avgUptime =
        rails.map((r) => r.uptime).reduce((a, b) => a + b) / rails.length;
    ...
    return MouseRegion(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(
            color: _isHovered ? widget.color.withValues(alpha: 0.3) : border,
          ),
          boxShadow:
              _isHovered
                  ? [
                ...
                child: AnimatedContainer(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      // Mini Latency Graph
                      _MiniLatencyGraph(
                        data: widget.rail.hourlyLatency,
                        color: statusColor,
                        isDark: isDark,
                      ),
                      const SizedBox(height: 8),
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 16),
                ...(List.from(rails)..sort(
                  (a, b) => b.uptime.compareTo(a.uptime),
                )).asMap().entries.map(
                  (entry) => _UptimeRow(
                    rank: entry.key + 1,
                    rail: entry.value,
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  color: textPrimary.withValues(
                    alpha: b == Brightness.dark ? 0.08 : 0.10,
                  ),
                  borderRadius: BorderRadius.circular(20),
                ),
                child: FractionallySizedBox(
...
class _AsidePanel extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      decoration: BoxDecoration(
        color: surface.withValues(
          alpha: brightness == Brightness.dark ? 0.62 : 0.95,
        ),
...
class _QuickActionsModal extends StatelessWidget {
  ...
  const _QuickActionsModal({required this.brightness});
              ...
              decoration: BoxDecoration(
                ...
                gradient: LinearGradient(
                  ...
                  colors: [
                    ...
                    bg.withValues(alpha: isDark ? 0.98 : 0.94),
                  ],
                ),
                border: Border.all(
                  color: border.withValues(alpha: isDark ? 0.9 : 1),
                ),
                boxShadow: [
                  BoxShadow(
                      ...
                      child: IgnorePointer(
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            gradient: RadialGradient(
                              colors: [
                                PayRouteColors.dashboardAccentOrange.withValues(
                                  alpha: 0.16,
                                ),
                                PayRouteColors.dashboardAccentOrange.withValues(
                                  alpha: 0,
                      ...
                      child: Column(
                        ...
                        children: [
                              ...
                              Expanded(
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    const SizedBox(height: 8),
                                    Text(
                                      'High-trust shortcuts and live activity in one focused surface.',
                                      style: GoogleFonts.inter(
                                        color: textSecondary,
                                        fontSize: 14,
                                        height: 1.5,
                          ...
                          Row(
                            children: [
                              Expanded(
                                child: _QuickActionHeroCard(
                                  label: 'Send',
                                  caption:
                                      'Transfer instantly to bank, wallet, or card',
                              ...
                              Expanded(
                                child: _QuickActionHeroCard(
                                  label: 'Request',
                                  caption:
                                      'Generate a trusted payment request in seconds',
                              ...
                              Expanded(
                                child: _QuickActionHeroCard(
                                  label: 'Exchange',
                                  caption:
                                      'Lock rates and route liquidity intelligently',
                                    ...
                                    children: [
                                      Column(
                                        ...
                                        children: [
                                          ...
                                          const SizedBox(height: 4),
                                          Text(
                                            'A refined view of your most recent high-signal movement.',
                                            style: GoogleFonts.inter(
                                              color: textSecondary,
                                              fontSize: 13,
                                            ),
...
class _QuickActionsInsightPill extends StatelessWidget {
  final Brightness brightness;
  final IconData icon;
  final String label;
  final String value;
  ...
  const _QuickActionsInsightPill({
    required this.brightness,
    required this.icon,
    required this.label,
    required this.value,
...
class _QuickActionHeroCard extends StatefulWidget {
  final String label;
  ...
  @override
  State<_QuickActionHeroCard> createState() => _QuickActionHeroCardState();
}

class _QuickActionHeroCardState extends State<_QuickActionHeroCard> {
  bool _isHovered = false;
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          ...
          gradient: LinearGradient(
            ...
            colors: [
              widget.color.withValues(alpha: _isHovered ? 0.14 : 0.09),
              Colors.white.withValues(alpha: isDark ? 0.03 : 0.55),
            ],
          ),
          boxShadow: [
            BoxShadow(
              ...
              children: [
                ...
                AnimatedContainer(
                  ...
                  child: Icon(
                    ...
                    size: 18,
                    color: _isHovered ? Colors.white : textSecondary,
                  ),
                ),
              ],
            ),
...
class _QuickActionActivityTile extends StatelessWidget {
  final String title;
  final String subtitle;
  final String amount;
  final IconData icon;
  ...
  const _QuickActionActivityTile({
    required this.title,
    required this.subtitle,
      ...
      child: AnimatedBuilder(
        ...
        builder: (context, child) {
          ...
          return AnimatedContainer(
            ...
            decoration: BoxDecoration(
              color:
                  _isHovered ? widget.color.withValues(alpha: 0.08) : surface,
              borderRadius: BorderRadius.circular(16),
              border: Border.all(
                color:
                    _isHovered ? widget.color.withValues(alpha: 0.3) : border,
              ),
              boxShadow:
                  _isHovered
                      ? [
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          const SizedBox(height: 4),
          Text(
            'Connect your payment rails to monitor their status.',
            style: GoogleFonts.inter(
...
class _TopUpButtonState extends State<_TopUpButton> {
  ...
  void _showTopUpModal(BuildContext context) {
    showModalBottomSheet<void>(
      ...
      builder:
          (context) => TopUpBankAccountModal(brightness: widget.brightness),
    );
  }
        ...
        return Container(
          ...
          decoration: BoxDecoration(
            gradient: LinearGradient(
              ...
              colors: [
                PayRouteColors.dashboardPrimary.withValues(
                  alpha: 0.08 + pulseValue * 0.04,
                ),
                PayRouteColors.dashboardAccentOrange.withValues(
                  alpha: 0.03 + pulseValue * 0.02,
                ),
                Colors.transparent,
              ],
            ),
...
class _ProceedToPaymentButton extends StatefulWidget {
  ...
  @override
  State<_ProceedToPaymentButton> createState() =>
      _ProceedToPaymentButtonState();
}
            ...
            color:
                widget.isCopied
                    ...
                    : (_isHovered
                        ...
                        : widget.surface.withValues(
                          alpha: widget.isDark ? 0.5 : 1,
                        )),
            borderRadius: BorderRadius.circular(14),
            border: Border.all(
              color:
